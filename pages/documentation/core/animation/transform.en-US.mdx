...
- `sequences: TransformDefinitions.Sequence<T>[]` - See [TransformDefinitions](../types/TransformDefinitions).Sequence
- `sequenceOptions?: Partial<TransformDefinitions.TransformConfig>` - See [TransformDefinitions](../types/TransformDefinitions).TransformConfig
...
- `props: SequenceProps<T>` - See [TransformDefinitions](../types/TransformDefinitions).SequenceProps
- `options?: Partial<TransformDefinitions.CommonTransformProps>` - See [TransformDefinitions](../types/TransformDefinitions).CommonTransformProps
