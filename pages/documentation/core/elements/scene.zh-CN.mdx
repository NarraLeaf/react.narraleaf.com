...
- `actions: (ChainableAction | ChainableAction[])[]` - 要执行的操作，参见 [ChainedActions](../types/ChainedActions)
...
- `actions: ((scene: Scene) => ChainedAction[])` - 要执行的操作，参见 [ChainedActions](../types/ChainedActions)
- 返回 `this`
