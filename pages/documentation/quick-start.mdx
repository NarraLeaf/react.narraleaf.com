import { FileTree, Callout, Tabs, Cards } from 'nextra/components';
...
You may notice that we use `toActions()` to convert the actions to an *action array*.  
This is because the framework need to track the order of the actions. 
Everytimes you call an action, you have to call `toActions()` to convert it to an *action array*.

<Callout type="warning" emoji="⚠️">
    Do not forget to call `toActions()` after you call an action, and do not call this method at the other place.
</Callout>
